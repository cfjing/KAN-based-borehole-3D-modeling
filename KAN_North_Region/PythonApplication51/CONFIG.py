...
# 3D Modeling and Visualization Parameters  ---
GRID_RESOLUTION_3D =300        # Resolution
SECTION_RESOLUTION_2D = 200    # Cross-section resolution
DEM_MAX_POINTS = 300000            # Maximum number of points sampled from the DEM for visualization
BOREHOLE_PROJECTION_THRESHOLD = 200 # The projected distance of boreholes on a cross-section

# Start and End Points of the Section View
SECTIONS = [
